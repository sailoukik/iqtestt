import React, {
    ...
    {
      id: 0,
      text: " Another name for the ankle bone is the:",
      answers: [
      "Tarsus",
      "Metatarsus",
      "Calcaneus",
    ...
    
    {
      ...
      answers: ["Spinal cord and sensory nerves", "Motor and sensory nerves", "Brain and sensory nerves", "Brain and spinal cord"],
      correct: 1,
      selection: null },
    
    {
      id: 2,
      text: "The topographic term used to describe the back surface of the body is:",
      answers: ["Exterior", "Anterior", "Posterior", "Inferior"],
      correct: 2,
      selection: null },
    
    {
      id: 3,
      text: "Which of the following vertebrae are found in the neck?",
      answers: ["Cervical", "Lumbar", "Sacral", "Coccyx"],
      correct: 0,
      selection: null },
    
    {
      id: 4,
      text: "Which of the following vessels does NOT carry blood back to the heart?",
      answers: ["Inferior venae cavae", "Superior venae cavae", "Pulmonary artery", "Pulmonary vein"],
      correct: 2,
      selection: null },
    
    {
      id: 5,
      text: "A prominence called the olecranon process is found on the:",      
      answers: ["Knee", "Hip", "Elbow", "Shoulder"],
      correct: 2,
      selection: null },
    ...
    {
      id: 7,
      text: "The system responsible for body movement and body shape is the:      ",
      answers: ["Musculoskeletal system", "Skeletal system", "Nervous system", "Muscular system"],
      correct: 0,
      selection: null },
    
    {
      ...
      answers: ["Skeletal", "Cardiovascular", "Nervous", "Endocrine"],
      correct: 3,
      selection: null },
    
    {
      id: 9,
      text: " Bilateral fractures of the femur indicate:",
      answers: [
    ...
    function App() {
      ...
      return /*#__PURE__*/(
        ...
        React.createElement("h1", { className: "intro-title" }, "Medical IQ Quiz"),
